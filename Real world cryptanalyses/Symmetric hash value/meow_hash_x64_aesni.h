...
//The partial process of using reversibility attack, and the reasonable inversion of the original partial process
#define MEOW_MIX_REG_attack(r1, r2, r3, r4, r5,  i1, i2, i3, i4) \
pxor(r4, i4);                \
psubq(r5, i3);               \
pxor(r2, r4);                \
aesenc(r2, r4);              \
...
static void Invertibility(meow_umm Len, void* Msg) 
{
    ...
    palignr(xmm12, xmm15, 15);
    palignr(xmm14, xmm15, 1);
    MEOW_MIX_REG_attack(xmm1, xmm5, xmm7, xmm2, xmm3, xmm12, xmm13, xmm14, xmm15);
    printf("%s\n", "After A Second(The initial value is all 0): ");
    Print(xmm0);
    Print(xmm1);
    Print(xmm2);
    Print(xmm3);
    ...
    MEOW_MIX_REG_attack(xmm0, xmm4, xmm6, xmm1, xmm2, xmm8, xmm9, xmm10, xmm11);
    printf("%s\n", "KEY: ");
    Print(xmm0);
    Print(xmm1);
    Print(xmm2);
